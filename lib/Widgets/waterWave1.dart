...
class WaterWave1 extends StatefulWidget {
  @override
  _WaterWave1State createState() => _WaterWave1State();
}

class _WaterWave1State extends State<WaterWave1>
        ...
        children: [
          ...
          Container(
            child: CustomPaint(
              size: Size(MediaQuery.of(context).size.width,
                  MediaQuery.of(context).size.height),
              painter: WaterWaveLightBlue(waveHeightIndex: waveHeightIndex),
            ),
          ),
        ],
      ),
